...
**1) Starting the backend server -** Open the terminal in your IDE and navigate to the backend directory. Next, install the relevant dependencies and then start the backend server using the following code.
```
